...
- `.github/workflows/n8n-import-bundle-live-sync.yml`

What it does on each run:

1. Starts the Docker stack.
2. Runs `make n8n-import-bundle-live`.
3. Exports live workflows from n8n.
4. Rewrites `workflows/bundle.workflows.json` and `workflows/WF_*.json`.
5. Commits and pushes changes if there is a diff.
...
- `push_changes` (boolean, default `true`)
